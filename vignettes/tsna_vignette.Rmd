...
The `tEdgeDensity` function is a network-level metric to compute the *temporal density* of a networkDynamic object.  It can be thought of as a crude measure of the total connectivity in the network.  It is expressed as a measure of the total amount of time vertices are connected by active edges in the network, divided by the amount of time they could possibly be connected.  
